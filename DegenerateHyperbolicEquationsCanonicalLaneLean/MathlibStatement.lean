...
import DegenerateHyperbolicEquationsCanonicalLaneLean.MathlibObjects
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "degenerate-hyperbolic-canonical-lane",
  theoremObject := "Degenerate Hyperbolic Equations: Hardy-Weinberg equilibrium, linkage analysis, sequence alignment, phylogenetics",
